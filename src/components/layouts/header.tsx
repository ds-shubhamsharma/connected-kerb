...
const Header = (headerItem: props) => {
  ...
  return (
    <>
      <div className="header-bg site-header">
        <div className="logo">
          <svg
        ...
        {/* <Link href="#" eventName={`logo`}>
          <img className="h-[300] w-[300] bg-[#8dc63f]"
            src="https://www.cenex.co.uk/app/uploads/2019/10/Picture3.png"
            alt=""
          />
        </Link> */}
